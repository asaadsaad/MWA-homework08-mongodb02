...
* Write a single API that will find the nearest 3 points to MIU location `(lat: 41.017654, long: -91.9665342)`, MIU location can be hard coded into your API, your search criteria may include a `category`. Example: `http://localhost:3000/search?category=restaurant` will find the nearest 3 restaurants to MIU campus.
